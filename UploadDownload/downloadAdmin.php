...
<body>
	...
	<div class="topnav">
		...
		<a style="float: left;" class="active" href="downloadAdmin.php">HOME</a>
		<a style="float: left;" href="upload.php">UPLOAD NEW</a>
	</div><br>
<!-- 
	...
	<button><a href=downloadAdmin.php>Kembali</a></button>
</div>
	</form>
